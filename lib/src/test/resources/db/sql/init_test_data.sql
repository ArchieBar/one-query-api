...
alter user demo_user with login password '123456';

grant all on
all tables in schema demo_schema to demo_user;

grant connect on
database postgres to demo_user;

grant usage,
create
  on
  schema demo_schema to demo_user;

grant all on
schema demo_schema to demo_user;

alter default privileges in schema demo_schema grant all on
tables to demo_user;

alter default privileges in schema demo_schema grant all on
sequences to demo_user;

alter default privileges in schema demo_schema grant all on
functions to demo_user;
