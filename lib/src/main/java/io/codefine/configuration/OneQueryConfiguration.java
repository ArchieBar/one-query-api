package io.codefine.configuration;

import io.codefine.impl.OneQuery;
 ...
 *
 * <p>Serves as an implementation of mapper register, where static field {@link Map}<{@link
 * SQLDialect}, {@link OneQueryMapper}> is used to bind SQL dialect to a certain mapper.
 *
