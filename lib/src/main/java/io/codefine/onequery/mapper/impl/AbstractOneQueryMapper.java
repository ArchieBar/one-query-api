...
abstract class AbstractOneQueryMapper implements OneQueryMapper {
  ...
  AbstractOneQueryMapper(final Map<String, Field<?>> configurationMap) {
    this.configurationMap = configurationMap;
    this.objectMapper = new ObjectMapper();
  }

  AbstractOneQueryMapper(final ObjectMapper objectMapper, Map<String, Field<?>> configurationMap) {
